...
{
    public class UsuarioStorage : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        private readonly IRepositorioUsuarios repositorioUsuarios;

        public UsuarioStorage(IRepositorioUsuarios repositorioUsuarios)
        {
