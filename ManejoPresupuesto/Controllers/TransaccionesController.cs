...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController : Controller
    {
        ...
        private FileResult GenerarExcel(string nombreArchivo, IEnumerable<Transaccion> transacciones)
        {
            ...
            foreach (var transaccion in transacciones)
            {
                dataTable.Rows.Add(transaccion.FechaTransaccion, 
                    transaccion.Cuenta, transaccion.Categoria, transaccion.Nota, 
                    transaccion.Monto, transaccion.TipoOperacionId);
            }
        ...
        {
            var usuarioId = servicioUsuario.ObtenerUsuarioId();
            var modelo = new TransaccioneCreacionViewModel
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Crear(TransaccioneCreacionViewModel modelo)
        {
            var usuarioId = servicioUsuario.ObtenerUsuarioId();
        ...
        public async Task<IActionResult> Editar(int id, string urlRetorno = null)
        {
            ...
            if (transaccion is null)
            {
                return RedirectToAction("NoEncontraddo", "Home");
            }
            ...
            TipoOperacion tipoOperacion)
        {
            ...
            var resultado = 
                categorias.Select(x => new SelectListItem(x.Nombre, x.Id.ToString())).ToList() ;
